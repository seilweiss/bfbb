...
/* 800A7DB8 000A4BB8  90 0D 90 68 */	stw r0, lbl_803CB968@sda21(r13)
...
/* 800A7DF0 000A4BF0  80 0D 90 68 */	lwz r0, lbl_803CB968@sda21(r13)
/* 800A7DF4 000A4BF4  54 00 10 3A */	slwi r0, r0, 2
/* 800A7DF8 000A4BF8  7C 7F 01 2E */	stwx r3, r31, r0
/* 800A7DFC 000A4BFC  80 6D 90 68 */	lwz r3, lbl_803CB968@sda21(r13)
/* 800A7E00 000A4C00  38 03 00 01 */	addi r0, r3, 1
/* 800A7E04 000A4C04  90 0D 90 68 */	stw r0, lbl_803CB968@sda21(r13)
lbl_800A7E08:
/* 800A7E08 000A4C08  80 AD 90 68 */	lwz r5, lbl_803CB968@sda21(r13)
...
/* 800A7E8C 000A4C8C  C0 02 93 E8 */	lfs f0, lbl_803CDD68@sda21(r2)
...
/* 800A7ECC 000A4CCC  C0 02 93 E8 */	lfs f0, lbl_803CDD68@sda21(r2)
...
/* 800A7F58 000A4D58  C0 02 93 E8 */	lfs f0, lbl_803CDD68@sda21(r2)
...
lbl_800A7F68:
/* 800A7F68 000A4D68  80 0D 90 68 */	lwz r0, lbl_803CB968@sda21(r13)
...
/* 800A800C 000A4E0C  C0 22 93 EC */	lfs f1, lbl_803CDD6C@sda21(r2)
...
/* 800A81C0 000A4FC0  C0 02 93 FC */	lfs f0, lbl_803CDD7C@sda21(r2)
...
/* 800A81E0 000A4FE0  C0 02 93 EC */	lfs f0, lbl_803CDD6C@sda21(r2)
/* 800A81E4 000A4FE4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A81E8 000A4FE8  40 81 00 48 */	ble lbl_800A8230
/* 800A81EC 000A4FEC  C0 02 94 00 */	lfs f0, lbl_803CDD80@sda21(r2)
...
/* 800A8454 000A5254  C0 42 94 08 */	lfs f2, lbl_803CDD88@sda21(r2)
/* 800A8458 000A5258  C0 02 94 0C */	lfs f0, lbl_803CDD8C@sda21(r2)
...
/* 800A848C 000A528C  C0 02 93 F4 */	lfs f0, lbl_803CDD74@sda21(r2)
...
/* 800A84B4 000A52B4  C0 02 93 FC */	lfs f0, lbl_803CDD7C@sda21(r2)
...
/* 800A84D8 000A52D8  C0 02 93 EC */	lfs f0, lbl_803CDD6C@sda21(r2)
...
/* 800A8520 000A5320  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
...
lbl_800A857C:
/* 800A857C 000A537C  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
...
lbl_800A85D4:
/* 800A85D4 000A53D4  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
...
/* 800A8688 000A5488  C0 02 94 08 */	lfs f0, lbl_803CDD88@sda21(r2)
...
/* 800A86DC 000A54DC  C0 02 94 10 */	lfs f0, lbl_803CDD90@sda21(r2)
...
/* 800A86F4 000A54F4  C0 02 94 14 */	lfs f0, lbl_803CDD94@sda21(r2)
...
/* 800A874C 000A554C  C0 42 94 18 */	lfs f2, lbl_803CDD98@sda21(r2)
/* 800A8750 000A5550  EC 01 00 2A */	fadds f0, f1, f0
/* 800A8754 000A5554  C0 62 93 EC */	lfs f3, lbl_803CDD6C@sda21(r2)
...
lbl_800A877C:
/* 800A877C 000A557C  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
/* 800A8780 000A5580  D0 1F 00 20 */	stfs f0, 0x20(r31)
/* 800A8784 000A5584  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
/* 800A8788 000A5588  D0 1F 00 24 */	stfs f0, 0x24(r31)
/* 800A878C 000A558C  C0 02 94 04 */	lfs f0, lbl_803CDD84@sda21(r2)
...
/* 800A87B8 000A55B8  C0 22 94 1C */	lfs f1, lbl_803CDD9C@sda21(r2)
