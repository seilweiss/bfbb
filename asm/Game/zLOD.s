...
/* 800A1D3C 0009EB3C  80 AD 90 14 */	lwz r5, lbl_803CB914@sda21(r13)
...
lbl_800A1D6C:
/* 800A1D6C 0009EB6C  80 0D 90 08 */	lwz r0, lbl_803CB908@sda21(r13)
/* 800A1D70 0009EB70  38 C0 00 00 */	li r6, 0
/* 800A1D74 0009EB74  80 8D 90 0C */	lwz r4, lbl_803CB90C@sda21(r13)
...
/* 800A1DD0 0009EBD0  C0 02 92 C4 */	lfs f0, lbl_803CDC44@sda21(r2)
...
/* 800A1DFC 0009EBFC  C3 E2 92 C0 */	lfs f31, lbl_803CDC40@sda21(r2)
lbl_800A1E00:
/* 800A1E00 0009EC00  54 DE 28 34 */	slwi r30, r6, 5
/* 800A1E04 0009EC04  48 00 00 30 */	b lbl_800A1E34
lbl_800A1E08:
/* 800A1E08 0009EC08  80 6D 90 0C */	lwz r3, lbl_803CB90C@sda21(r13)
...
/* 800A1E24 0009EC24  C0 02 92 C8 */	lfs f0, lbl_803CDC48@sda21(r2)
...
/* 800A1E3C 0009EC3C  80 0D 90 14 */	lwz r0, lbl_803CB914@sda21(r13)
...
/* 800A1E54 0009EC54  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
/* 800A1E6C 0009EC6C  C0 02 92 CC */	lfs f0, lbl_803CDC4C@sda21(r2)
/* 800A1E70 0009EC70  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
/* 800A1E84 0009EC84  C0 02 92 CC */	lfs f0, lbl_803CDC4C@sda21(r2)
/* 800A1E88 0009EC88  3C 60 80 2F */	lis r3, lbl_802EA990@ha
/* 800A1E8C 0009EC8C  80 0D 90 14 */	lwz r0, lbl_803CB914@sda21(r13)
...
/* 800A1EA8 0009ECA8  80 6D 90 14 */	lwz r3, lbl_803CB914@sda21(r13)
/* 800A1EAC 0009ECAC  38 03 00 01 */	addi r0, r3, 1
/* 800A1EB0 0009ECB0  90 0D 90 14 */	stw r0, lbl_803CB914@sda21(r13)
...
/* 800A1F78 0009ED78  90 0D 90 08 */	stw r0, lbl_803CB908@sda21(r13)
/* 800A1F7C 0009ED7C  90 0D 90 0C */	stw r0, lbl_803CB90C@sda21(r13)
/* 800A1F80 0009ED80  90 0D 90 14 */	stw r0, lbl_803CB914@sda21(r13)
...
/* 800A1FAC 0009EDAC  80 8D 90 08 */	lwz r4, lbl_803CB908@sda21(r13)
...
/* 800A1FBC 0009EDBC  90 0D 90 08 */	stw r0, lbl_803CB908@sda21(r13)
lbl_800A1FC0:
/* 800A1FC0 0009EDC0  7C 1C E8 40 */	cmplw r28, r29
/* 800A1FC4 0009EDC4  41 80 FF D8 */	blt lbl_800A1F9C
/* 800A1FC8 0009EDC8  80 0D 90 08 */	lwz r0, lbl_803CB908@sda21(r13)
...
/* 800A1FE4 0009EDE4  90 6D 90 0C */	stw r3, lbl_803CB90C@sda21(r13)
/* 800A1FE8 0009EDE8  3B 80 00 00 */	li r28, 0
/* 800A1FEC 0009EDEC  3F E0 4C 4F */	lis r31, 0x4c4f
/* 800A1FF0 0009EDF0  83 6D 90 0C */	lwz r27, lbl_803CB90C@sda21(r13)
...
lbl_800A2044:
/* 800A2044 0009EE44  80 6D 90 0C */	lwz r3, lbl_803CB90C@sda21(r13)
...
/* 800A2058 0009EE58  80 6D 90 0C */	lwz r3, lbl_803CB90C@sda21(r13)
...
/* 800A207C 0009EE7C  80 8D 90 0C */	lwz r4, lbl_803CB90C@sda21(r13)
/* 800A2080 0009EE80  7C 64 F9 2E */	stwx r3, r4, r31
/* 800A2084 0009EE84  48 00 00 10 */	b lbl_800A2094
lbl_800A2088:
/* 800A2088 0009EE88  80 6D 90 0C */	lwz r3, lbl_803CB90C@sda21(r13)
...
lbl_800A209C:
/* 800A209C 0009EE9C  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
/* 800A20C8 0009EEC8  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
lbl_800A20DC:
/* 800A20DC 0009EEDC  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
lbl_800A20F0:
/* 800A20F0 0009EEF0  80 0D 90 0C */	lwz r0, lbl_803CB90C@sda21(r13)
...
lbl_800A2120:
/* 800A2120 0009EF20  80 0D 90 08 */	lwz r0, lbl_803CB908@sda21(r13)
...
/* 800A2134 0009EF34  90 0D 90 14 */	stw r0, lbl_803CB914@sda21(r13)
...
zLOD_Update__FUi:
/* 800A2164 0009EF64  80 0D 90 14 */	lwz r0, lbl_803CB914@sda21(r13)
...
lbl_800A21AC:
/* 800A21AC 0009EFAC  80 6D 90 10 */	lwz r3, lbl_803CB910@sda21(r13)
/* 800A21B0 0009EFB0  38 03 00 01 */	addi r0, r3, 1
/* 800A21B4 0009EFB4  90 0D 90 10 */	stw r0, lbl_803CB910@sda21(r13)
/* 800A21B8 0009EFB8  80 6D 90 10 */	lwz r3, lbl_803CB910@sda21(r13)
/* 800A21BC 0009EFBC  80 0D 90 14 */	lwz r0, lbl_803CB914@sda21(r13)
...
/* 800A21CC 0009EFCC  90 0D 90 10 */	stw r0, lbl_803CB910@sda21(r13)
lbl_800A21D0:
/* 800A21D0 0009EFD0  80 0D 90 10 */	lwz r0, lbl_803CB910@sda21(r13)
...
/* 800A21F0 0009EFF0  C0 02 92 C4 */	lfs f0, lbl_803CDC44@sda21(r2)
...
/* 800A2208 0009F008  C0 82 92 D0 */	lfs f4, lbl_803CDC50@sda21(r2)
...
/* 800A2220 0009F020  C0 A2 92 C0 */	lfs f5, lbl_803CDC40@sda21(r2)
lbl_800A2224:
...
/* 800A228C 0009F08C  80 0D 90 10 */	lwz r0, lbl_803CB910@sda21(r13)
...
lbl_800A2338:
/* 800A2338 0009F138  80 0D 90 10 */	lwz r0, lbl_803CB910@sda21(r13)
...
lbl_800A23BC:
/* 800A23BC 0009F1BC  80 CD 90 0C */	lwz r6, lbl_803CB90C@sda21(r13)
/* 800A23C0 0009F1C0  38 E0 00 00 */	li r7, 0
/* 800A23C4 0009F1C4  80 0D 90 08 */	lwz r0, lbl_803CB908@sda21(r13)
...
/* 800A2438 0009F238  80 0D 90 14 */	lwz r0, lbl_803CB914@sda21(r13)
...
/* 800A2484 0009F284  C0 02 92 CC */	lfs f0, lbl_803CDC4C@sda21(r2)
...
/* 800A2494 0009F294  C0 02 92 CC */	lfs f0, lbl_803CDC4C@sda21(r2)
...
/* 800A24BC 0009F2BC  C0 02 92 C4 */	lfs f0, lbl_803CDC44@sda21(r2)
...
/* 800A24D4 0009F2D4  C0 82 92 D0 */	lfs f4, lbl_803CDC50@sda21(r2)
...
/* 800A24EC 0009F2EC  C0 A2 92 C0 */	lfs f5, lbl_803CDC40@sda21(r2)
lbl_800A24F0:
...
/* 800A2558 0009F358  80 0D 90 10 */	lwz r0, lbl_803CB910@sda21(r13)
...
lbl_800A2604:
/* 800A2604 0009F404  80 0D 90 10 */	lwz r0, lbl_803CB910@sda21(r13)
