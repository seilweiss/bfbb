...
/* 800A6EBC 000A3CBC  C0 22 93 C8 */	lfs f1, lbl_803CDD48@sda21(r2)
/* 800A6EC0 000A3CC0  D0 26 00 00 */	stfs f1, 0(r6)
/* 800A6EC4 000A3CC4  C0 02 93 CC */	lfs f0, lbl_803CDD4C@sda21(r2)
...
/* 800A6F6C 000A3D6C  90 0D 90 58 */	stw r0, lbl_803CB958@sda21(r13)
...
/* 800A7430 000A4230  C3 E2 93 CC */	lfs f31, lbl_803CDD4C@sda21(r2)
...
/* 800A7460 000A4260  3B 8D 90 5C */	addi r28, r13, lbl_803CB95C@sda21
...
lbl_800A74B8:
/* 800A74B8 000A42B8  83 4D 82 D0 */	lwz r26, lbl_803CABD0@sda21(r13)
...
/* 800A7530 000A4330  C0 42 93 C8 */	lfs f2, lbl_803CDD48@sda21(r2)
...
/* 800A7554 000A4354  C0 02 93 D4 */	lfs f0, lbl_803CDD54@sda21(r2)
/* 800A7558 000A4358  C0 42 93 D0 */	lfs f2, lbl_803CDD50@sda21(r2)
...
/* 800A7598 000A4398  C0 62 93 C8 */	lfs f3, lbl_803CDD48@sda21(r2)
...
/* 800A75F0 000A43F0  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
lbl_800A7610:
/* 800A7610 000A4410  38 8D 82 D0 */	addi r4, r13, lbl_803CABD0@sda21
...
zMusicNotify__Fi:
/* 800A7640 000A4440  80 0D 90 58 */	lwz r0, lbl_803CB958@sda21(r13)
...
/* 800A7688 000A4488  38 8D 82 D8 */	addi r4, r13, lbl_803CABD8@sda21
/* 800A768C 000A448C  C0 05 00 10 */	lfs f0, 0x10(r5)
/* 800A7690 000A4490  38 6D 90 5C */	addi r3, r13, lbl_803CB95C@sda21
...
/* 800A76C0 000A44C0  80 0D 90 58 */	lwz r0, lbl_803CB958@sda21(r13)
/* 800A76C4 000A44C4  28 00 00 00 */	cmplwi r0, 0
/* 800A76C8 000A44C8  40 82 00 E4 */	bne lbl_800A77AC
/* 800A76CC 000A44CC  C0 22 93 C8 */	lfs f1, lbl_803CDD48@sda21(r2)
...
/* 800A76F8 000A44F8  38 8D 82 D0 */	addi r4, r13, lbl_803CABD0@sda21
...
/* 800A7720 000A4520  38 8D 90 5C */	addi r4, r13, lbl_803CB95C@sda21
...
/* 800A775C 000A455C  38 8D 82 D8 */	addi r4, r13, lbl_803CABD8@sda21
/* 800A7760 000A4560  C0 27 00 10 */	lfs f1, 0x10(r7)
/* 800A7764 000A4564  38 AD 90 5C */	addi r5, r13, lbl_803CB95C@sda21
...
/* 800A77D4 000A45D4  80 0D 90 58 */	lwz r0, lbl_803CB958@sda21(r13)
...
/* 800A77F0 000A45F0  3B ED 82 D8 */	addi r31, r13, lbl_803CABD8@sda21
/* 800A77F4 000A45F4  C0 03 00 14 */	lfs f0, 0x14(r3)
/* 800A77F8 000A45F8  3B CD 90 5C */	addi r30, r13, lbl_803CB95C@sda21
...
/* 800A785C 000A465C  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
/* 800A7894 000A4694  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
/* 800A78B0 000A46B0  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
lbl_800A78C0:
/* 800A78C0 000A46C0  C0 22 93 C8 */	lfs f1, lbl_803CDD48@sda21(r2)
...
/* 800A7948 000A4748  C0 02 93 D8 */	lfs f0, lbl_803CDD58@sda21(r2)
...
/* 800A7964 000A4764  C0 02 93 DC */	lfs f0, lbl_803CDD5C@sda21(r2)
...
/* 800A7994 000A4794  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
lbl_800A79CC:
/* 800A79CC 000A47CC  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
/* 800A7A00 000A4800  C0 02 93 C8 */	lfs f0, lbl_803CDD48@sda21(r2)
...
/* 800A7A48 000A4848  C0 02 93 CC */	lfs f0, lbl_803CDD4C@sda21(r2)
...
/* 800A7B24 000A4924  80 0D 90 58 */	lwz r0, lbl_803CB958@sda21(r13)
...
/* 800A7B60 000A4960  90 0D 90 58 */	stw r0, lbl_803CB958@sda21(r13)
lbl_800A7B64:
...
/* 800A7B9C 000A499C  80 0D 90 58 */	lwz r0, lbl_803CB958@sda21(r13)
...
/* 800A7BE0 000A49E0  C0 42 93 C8 */	lfs f2, lbl_803CDD48@sda21(r2)
...
/* 800A7C3C 000A4A3C  90 0D 90 58 */	stw r0, lbl_803CB958@sda21(r13)
lbl_800A7C40:
...
/* 800A7C78 000A4A78  C0 02 93 E0 */	lfs f0, lbl_803CDD60@sda21(r2)
...
/* 800A7CA0 000A4AA0  80 0D 82 D0 */	lwz r0, lbl_803CABD0@sda21(r13)
