...
/* 8013619C 00132F9C  90 0D 96 40 */	stw r0, l_bf40_g_boss_is_in_the_house@sda21(r13)
...
/* 801361A8 00132FA8  90 0D 96 40 */	stw r0, l_bf40_g_boss_is_in_the_house@sda21(r13)
...
/* 8013633C 0013313C  3C 60 80 27 */	lis r3, l_cbb8__esc__2_stringBase0@ha
/* 80136340 00133140  38 80 00 00 */	li r4, 0
/* 80136344 00133144  90 01 00 34 */	stw r0, 0x34(r1)
/* 80136348 00133148  38 63 CB B8 */	addi r3, r3, l_cbb8__esc__2_stringBase0@l
/* 8013634C 0013314C  38 63 03 6D */	addi r3, r3, 0x36d
/* 80136350 00133150  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 80136354 00133154  80 A2 A3 88 */	lwz r5, l_ed08__esc__2_917@sda21(r2)
...
/* 801363AC 001331AC  C0 22 A3 90 */	lfs f1, l_ed10__esc__2_920@sda21(r2)
/* 801363B0 001331B0  C0 42 A3 94 */	lfs f2, l_ed14__esc__2_921@sda21(r2)
...
/* 801363BC 001331BC  C0 22 A3 98 */	lfs f1, l_ed18__esc__2_922@sda21(r2)
...
/* 801363FC 001331FC  80 0D 96 40 */	lwz r0, l_bf40_g_boss_is_in_the_house@sda21(r13)
...
/* 8013640C 0013320C  90 0D 96 40 */	stw r0, l_bf40_g_boss_is_in_the_house@sda21(r13)
...
/* 8013642C 0013322C  3C 60 80 27 */	lis r3, l_cbb8__esc__2_stringBase0@ha
/* 80136430 00133230  38 63 CB B8 */	addi r3, r3, l_cbb8__esc__2_stringBase0@l
...
/* 80136440 00133240  3C 80 80 32 */	lis r4, l_4468_g_parf_holder@ha
/* 80136444 00133244  90 6D 96 44 */	stw r3, l_bf44_g_pemit_holder@sda21(r13)
/* 80136448 00133248  38 64 44 68 */	addi r3, r4, l_4468_g_parf_holder@l
...
/* 8013657C 0013337C  C0 22 A3 9C */	lfs f1, l_ed1c__esc__2_947@sda21(r2)
...
.section .rodata
.global l_cbb8__esc__2_stringBase0
l_cbb8__esc__2_stringBase0:
	.4byte 0x556E6B6E
	.4byte 0x6F776E00
	.4byte 0x49646C65
	.4byte 0x30310049
...
.section .bss
l_4468_g_parf_holder:
	.skip 0x170

.section .sbss
l_bf40_g_boss_is_in_the_house:
	.skip 0x4
