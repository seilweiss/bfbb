...
/* 80195A20 00192820  90 0D 98 E0 */	stw r0, lbl_803CC1E0@sda21(r13)
/* 80195A24 00192824  90 0D 98 DC */	stw r0, lbl_803CC1DC@sda21(r13)
/* 80195A28 00192828  90 0D 98 D8 */	stw r0, lbl_803CC1D8@sda21(r13)
/* 80195A2C 0019282C  C0 02 B2 60 */	lfs f0, lbl_803CFBE0@sda21(r2)
/* 80195A30 00192830  D0 0D 98 E4 */	stfs f0, lbl_803CC1E4@sda21(r13)
...
/* 80195B2C 0019292C  D0 0D 84 C8 */	stfs f0, lbl_803CADC8@sda21(r13)
lbl_80195B30:
...
/* 80195BF8 001929F8  90 6D 98 D4 */	stw r3, lbl_803CC1D4@sda21(r13)
...
zCombo_Add__Fi:
/* 80195C10 00192A10  C0 2D 98 E4 */	lfs f1, lbl_803CC1E4@sda21(r13)
/* 80195C14 00192A14  C0 02 B2 64 */	lfs f0, lbl_803CFBE4@sda21(r2)
/* 80195C18 00192A18  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80195C1C 00192A1C  40 80 00 18 */	bge lbl_80195C34
/* 80195C20 00192A20  C0 0D 84 C8 */	lfs f0, lbl_803CADC8@sda21(r13)
/* 80195C24 00192A24  38 03 FF FF */	addi r0, r3, -1
/* 80195C28 00192A28  D0 0D 98 E4 */	stfs f0, lbl_803CC1E4@sda21(r13)
/* 80195C2C 00192A2C  90 0D 98 D8 */	stw r0, lbl_803CC1D8@sda21(r13)
/* 80195C30 00192A30  4E 80 00 20 */	blr 
lbl_80195C34:
/* 80195C34 00192A34  C0 0D 84 C8 */	lfs f0, lbl_803CADC8@sda21(r13)
/* 80195C38 00192A38  D0 0D 98 E4 */	stfs f0, lbl_803CC1E4@sda21(r13)
/* 80195C3C 00192A3C  80 0D 98 E0 */	lwz r0, lbl_803CC1E0@sda21(r13)
/* 80195C40 00192A40  7C 00 1A 14 */	add r0, r0, r3
/* 80195C44 00192A44  90 0D 98 E0 */	stw r0, lbl_803CC1E0@sda21(r13)
/* 80195C48 00192A48  80 8D 98 D8 */	lwz r4, lbl_803CC1D8@sda21(r13)
/* 80195C4C 00192A4C  2C 04 00 00 */	cmpwi r4, 0
/* 80195C50 00192A50  4D 82 00 20 */	beqlr 
/* 80195C54 00192A54  80 6D 98 E0 */	lwz r3, lbl_803CC1E0@sda21(r13)
/* 80195C58 00192A58  38 00 00 00 */	li r0, 0
/* 80195C5C 00192A5C  7C 63 22 14 */	add r3, r3, r4
/* 80195C60 00192A60  90 6D 98 E0 */	stw r3, lbl_803CC1E0@sda21(r13)
/* 80195C64 00192A64  90 0D 98 D8 */	stw r0, lbl_803CC1D8@sda21(r13)
...
/* 80195CF0 00192AF0  C0 22 B2 68 */	lfs f1, lbl_803CFBE8@sda21(r2)
...
/* 80195D00 00192B00  80 8D 98 E0 */	lwz r4, lbl_803CC1E0@sda21(r13)
...
lbl_80195D14:
/* 80195D14 00192B14  80 0D 98 DC */	lwz r0, lbl_803CC1DC@sda21(r13)
...
lbl_80195D64:
/* 80195D64 00192B64  80 0D 98 E0 */	lwz r0, lbl_803CC1E0@sda21(r13)
/* 80195D68 00192B68  90 0D 98 DC */	stw r0, lbl_803CC1DC@sda21(r13)
lbl_80195D6C:
...
lbl_80195DB0:
/* 80195DB0 00192BB0  80 6D 98 D4 */	lwz r3, lbl_803CC1D4@sda21(r13)
...
lbl_80195DD4:
/* 80195DD4 00192BD4  C0 2D 98 E4 */	lfs f1, lbl_803CC1E4@sda21(r13)
/* 80195DD8 00192BD8  C0 02 B2 64 */	lfs f0, lbl_803CFBE4@sda21(r2)
...
/* 80195DEC 00192BEC  D0 0D 98 E4 */	stfs f0, lbl_803CC1E4@sda21(r13)
/* 80195DF0 00192BF0  C0 2D 98 E4 */	lfs f1, lbl_803CC1E4@sda21(r13)
/* 80195DF4 00192BF4  C0 02 B2 64 */	lfs f0, lbl_803CFBE4@sda21(r2)
...
/* 80195ECC 00192CCC  C0 22 B2 6C */	lfs f1, lbl_803CFBEC@sda21(r2)
...
/* 80195F68 00192D68  C0 22 B2 64 */	lfs f1, lbl_803CFBE4@sda21(r2)
/* 80195F6C 00192D6C  3C 80 80 03 */	lis r4, lbl_8002EB84@ha
/* 80195F70 00192D70  3C 60 80 19 */	lis r3, lbl_80195C6C@ha
/* 80195F74 00192D74  C0 4D 84 CC */	lfs f2, lbl_803CADCC@sda21(r13)
...
lbl_80195FA0:
/* 80195FA0 00192DA0  C0 02 B2 60 */	lfs f0, lbl_803CFBE0@sda21(r2)
/* 80195FA4 00192DA4  38 00 00 00 */	li r0, 0
/* 80195FA8 00192DA8  D0 0D 98 E4 */	stfs f0, lbl_803CC1E4@sda21(r13)
/* 80195FAC 00192DAC  90 0D 98 E0 */	stw r0, lbl_803CC1E0@sda21(r13)
/* 80195FB0 00192DB0  90 0D 98 DC */	stw r0, lbl_803CC1DC@sda21(r13)
lbl_80195FB4:
