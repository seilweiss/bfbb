...
lbl_800ACE28:
/* 800ACE28 000A9C28  C0 22 94 B0 */	lfs f1, lbl_803CDE30@sda21(r2)
...
lbl_800ACE40:
/* 800ACE40 000A9C40  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
lbl_800ACE58:
/* 800ACE58 000A9C58  C0 22 94 B8 */	lfs f1, lbl_803CDE38@sda21(r2)
...
lbl_800ACE70:
/* 800ACE70 000A9C70  C0 22 94 BC */	lfs f1, lbl_803CDE3C@sda21(r2)
/* 800ACE74 000A9C74  7C A3 2B 78 */	mr r3, r5
/* 800ACE78 000A9C78  C0 42 94 B0 */	lfs f2, lbl_803CDE30@sda21(r2)
...
lbl_800ACE88:
/* 800ACE88 000A9C88  C0 22 94 B8 */	lfs f1, lbl_803CDE38@sda21(r2)
...
lbl_800ACEA0:
/* 800ACEA0 000A9CA0  C0 22 94 C0 */	lfs f1, lbl_803CDE40@sda21(r2)
...
lbl_800ACEB8:
/* 800ACEB8 000A9CB8  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
/* 800ACECC 000A9CCC  C0 22 94 C4 */	lfs f1, lbl_803CDE44@sda21(r2)
...
lbl_800ACEE8:
/* 800ACEE8 000A9CE8  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
lbl_800ACF00:
/* 800ACF00 000A9D00  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
lbl_800ACF18:
/* 800ACF18 000A9D18  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
/* 800ACF2C 000A9D2C  C0 22 94 B4 */	lfs f1, lbl_803CDE34@sda21(r2)
...
lbl_800ACF48:
/* 800ACF48 000A9D48  C0 22 94 C8 */	lfs f1, lbl_803CDE48@sda21(r2)
...
/* 800ACF5C 000A9D5C  C0 22 94 CC */	lfs f1, lbl_803CDE4C@sda21(r2)
...
lbl_800ACF78:
/* 800ACF78 000A9D78  C0 22 94 C0 */	lfs f1, lbl_803CDE40@sda21(r2)
...
lbl_800ACF90:
/* 800ACF90 000A9D90  C0 22 94 D0 */	lfs f1, lbl_803CDE50@sda21(r2)
...
lbl_800ACFA8:
/* 800ACFA8 000A9DA8  C0 22 94 D0 */	lfs f1, lbl_803CDE50@sda21(r2)
...
lbl_800ACFC0:
/* 800ACFC0 000A9DC0  C0 22 94 D0 */	lfs f1, lbl_803CDE50@sda21(r2)
...
lbl_800ACFD8:
/* 800ACFD8 000A9DD8  C0 22 94 D4 */	lfs f1, lbl_803CDE54@sda21(r2)
...
lbl_800ACFF0:
/* 800ACFF0 000A9DF0  C0 22 94 D8 */	lfs f1, lbl_803CDE58@sda21(r2)
...
lbl_800AD008:
/* 800AD008 000A9E08  C0 22 94 DC */	lfs f1, lbl_803CDE5C@sda21(r2)
...
/* 800AD0C4 000A9EC4  C0 02 94 E0 */	lfs f0, lbl_803CDE60@sda21(r2)
...
/* 800AD0E8 000A9EE8  C0 42 94 E4 */	lfs f2, lbl_803CDE64@sda21(r2)
/* 800AD0EC 000A9EEC  C0 02 94 E0 */	lfs f0, lbl_803CDE60@sda21(r2)
