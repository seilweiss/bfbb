...
.section .init  # 0x80003100 - 0x800056E0
...
/* 8000312C 0000012C  48 1D 22 49 */	bl OSResetSystem
lbl_80003130:
...
/* 80003144 00000144  98 0D 9C D8 */	stb r0, -0x6328(r13)
/* 80003148 00000148  4E 80 00 20 */	blr 

__get_debug_bba:
/* 8000314C 0000014C  88 6D 9C D8 */	lbz r3, -0x6328(r13)
...
/* 8000316C 0000016C  48 00 01 D5 */	bl __init_data
...
/* 800031E0 000001E0  4B FF FF 61 */	bl __set_debug_bba
/* 800031E4 000001E4  48 00 00 14 */	b lbl_800031F8
lbl_800031E8:
/* 800031E8 000001E8  3C C0 80 1F */	lis r6, lbl_801F5780@ha
/* 800031EC 000001EC  38 C6 57 80 */	addi r6, r6, lbl_801F5780@l
...
lbl_80003260:
/* 80003260 00000260  48 1B EA 91 */	bl DBInit
/* 80003264 00000264  48 1C DB 8D */	bl OSInit
...
lbl_80003288:
/* 80003288 00000288  4B FF FE 79 */	bl .init_proc
lbl_8000328C:
/* 8000328C 0000028C  4B FF FE C1 */	bl __get_debug_bba
/* 80003290 00000290  28 03 00 01 */	cmplwi r3, 1
/* 80003294 00000294  40 82 00 08 */	bne lbl_8000329C
/* 80003298 00000298  48 1D 47 31 */	bl func_801D79C8
lbl_8000329C:
/* 8000329C 0000029C  48 1D 47 31 */	bl __init_user
/* 800032A0 000002A0  7D C3 73 78 */	mr r3, r14
/* 800032A4 000002A4  7D E4 7B 78 */	mr r4, r15
/* 800032A8 000002A8  48 09 F3 F9 */	bl main
/* 800032AC 000002AC  48 1D 9A D0 */	b exit
...
/* 80003324 00000324  3C 20 80 3D */	lis r1, _stack_addr@h
/* 80003328 00000328  60 21 8A 50 */	ori r1, r1, _stack_addr@l
/* 8000332C 0000032C  3C 40 80 3D */	lis r2, _SDA2_BASE_@h
/* 80003330 00000330  60 42 49 80 */	ori r2, r2, _SDA2_BASE_@l
/* 80003334 00000334  3D A0 80 3D */	lis r13, _SDA_BASE_@h
/* 80003338 00000338  61 AD 29 00 */	ori r13, r13, _SDA_BASE_@l
...
/* 80003358 00000358  3C 60 80 00 */	lis r3, lbl_8000563C@ha
/* 8000335C 0000035C  38 03 56 3C */	addi r0, r3, lbl_8000563C@l
...
/* 800033A0 000003A0  48 00 00 85 */	bl __flush_cache
lbl_800033A4:
/* 800033A4 000003A4  3B BD 00 0C */	addi r29, r29, 0xc
/* 800033A8 000003A8  4B FF FF C4 */	b lbl_8000336C
lbl_800033AC:
/* 800033AC 000003AC  3C 60 80 00 */	lis r3, lbl_800056C0@ha
/* 800033B0 000003B0  38 03 56 C0 */	addi r0, r3, lbl_800056C0@l
...
/* 80003410 00000410  48 1C E1 85 */	bl __OSPSInit
/* 80003414 00000414  48 1C D7 29 */	bl __OSFPRInit
/* 80003418 00000418  48 1C F2 45 */	bl __OSCacheInit
...
/* 800035A4 000005A4  48 1F 05 85 */	bl func_801F3B28
...
/* 800036E4 000006E4  48 00 1E 34 */	b gTRKInterruptVectorTableEnd
...
/* 8000381C 0000081C  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003820 00000820  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003904 00000904  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003908 00000908  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003A04 00000A04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003A08 00000A08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003B04 00000B04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003B08 00000B08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003C04 00000C04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003C08 00000C08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003D04 00000D04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003D08 00000D08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003E04 00000E04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003E08 00000E08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80003F04 00000F04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80003F08 00000F08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004204 00001204  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004208 00001208  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004304 00001304  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004308 00001308  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004404 00001404  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004408 00001408  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004524 00001524  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004528 00001528  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004558 00001558  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 8000455C 0000155C  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004640 00001640  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004644 00001644  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004740 00001740  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004744 00001744  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004840 00001840  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004844 00001844  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004904 00001904  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004908 00001908  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004A04 00001A04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004A08 00001A08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004C04 00001C04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004C08 00001C08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80004D04 00001D04  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80004D08 00001D08  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80005204 00002204  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80005208 00002208  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80005304 00002304  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80005308 00002308  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80005404 00002404  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80005408 00002408  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80005504 00002504  3C 60 80 1F */	lis r3, lbl_801F3C2C@h
/* 80005508 00002508  60 63 3C 2C */	ori r3, r3, lbl_801F3C2C@l
...
/* 80005520 00002520  3C 60 80 38 */	lis r3, l_1250_lc_base@ha
/* 80005524 00002524  90 01 00 24 */	stw r0, 0x24(r1)
/* 80005528 00002528  38 63 12 50 */	addi r3, r3, l_1250_lc_base@l
/* 8000552C 0000252C  BF 61 00 0C */	stmw r27, 0xc(r1)
/* 80005530 00002530  80 63 00 00 */	lwz r3, 0(r3)
/* 80005534 00002534  28 03 00 44 */	cmplwi r3, 0x44
/* 80005538 00002538  41 81 00 2C */	bgt lbl_80005564
/* 8000553C 0000253C  38 03 40 00 */	addi r0, r3, 0x4000
/* 80005540 00002540  28 00 00 44 */	cmplwi r0, 0x44
/* 80005544 00002544  40 81 00 20 */	ble lbl_80005564
/* 80005548 00002548  3C 60 80 38 */	lis r3, lbl_80380D78@ha
/* 8000554C 0000254C  38 63 0D 78 */	addi r3, r3, lbl_80380D78@l
/* 80005550 00002550  80 03 02 38 */	lwz r0, 0x238(r3)
/* 80005554 00002554  54 00 07 BF */	clrlwi. r0, r0, 0x1e
/* 80005558 00002558  41 82 00 0C */	beq lbl_80005564
/* 8000555C 0000255C  38 A0 00 44 */	li r5, 0x44
/* 80005560 00002560  48 00 00 0C */	b lbl_8000556C
lbl_80005564:
/* 80005564 00002564  3C 60 80 00 */	lis r3, 0x80000044@ha
/* 80005568 00002568  38 A3 00 44 */	addi r5, r3, 0x80000044@l
lbl_8000556C:
/* 8000556C 0000256C  3C 80 80 2B */	lis r4, l_7658_TRK_ISR_OFFSETS@ha
/* 80005570 00002570  3C 60 80 38 */	lis r3, lbl_80380D78@ha
/* 80005574 00002574  83 A5 00 00 */	lwz r29, 0(r5)
/* 80005578 00002578  3B E4 76 58 */	addi r31, r4, l_7658_TRK_ISR_OFFSETS@l
/* 8000557C 0000257C  3B C3 0D 78 */	addi r30, r3, lbl_80380D78@l
/* 80005580 00002580  3B 80 00 00 */	li r28, 0
lbl_80005584:
/* 80005584 00002584  38 00 00 01 */	li r0, 1
/* 80005588 00002588  7C 00 E0 30 */	slw r0, r0, r28
/* 8000558C 0000258C  7F A0 00 39 */	and. r0, r29, r0
/* 80005590 00002590  41 82 00 88 */	beq lbl_80005618
/* 80005594 00002594  3C 60 80 38 */	lis r3, l_1250_lc_base@ha
/* 80005598 00002598  80 DF 00 00 */	lwz r6, 0(r31)
/* 8000559C 0000259C  38 63 12 50 */	addi r3, r3, l_1250_lc_base@l
/* 800055A0 000025A0  80 63 00 00 */	lwz r3, 0(r3)
/* 800055A4 000025A4  7C 06 18 40 */	cmplw r6, r3
/* 800055A8 000025A8  41 80 00 24 */	blt lbl_800055CC
/* 800055AC 000025AC  38 03 40 00 */	addi r0, r3, 0x4000
/* 800055B0 000025B0  7C 06 00 40 */	cmplw r6, r0
/* 800055B4 000025B4  40 80 00 18 */	bge lbl_800055CC
/* 800055B8 000025B8  80 1E 02 38 */	lwz r0, 0x238(r30)
/* 800055BC 000025BC  54 00 07 BF */	clrlwi. r0, r0, 0x1e
/* 800055C0 000025C0  41 82 00 0C */	beq lbl_800055CC
/* 800055C4 000025C4  7C DB 33 78 */	mr r27, r6
/* 800055C8 000025C8  48 00 00 2C */	b lbl_800055F4
lbl_800055CC:
/* 800055CC 000025CC  3C 00 7E 00 */	lis r0, 0x7e00
/* 800055D0 000025D0  7C 06 00 40 */	cmplw r6, r0
/* 800055D4 000025D4  41 80 00 18 */	blt lbl_800055EC
/* 800055D8 000025D8  3C 00 80 00 */	lis r0, 0x8000
/* 800055DC 000025DC  7C 06 00 40 */	cmplw r6, r0
/* 800055E0 000025E0  41 81 00 0C */	bgt lbl_800055EC
/* 800055E4 000025E4  7C DB 33 78 */	mr r27, r6
/* 800055E8 000025E8  48 00 00 0C */	b lbl_800055F4
lbl_800055EC:
/* 800055EC 000025EC  54 C0 00 BE */	clrlwi r0, r6, 2
/* 800055F0 000025F0  64 1B 80 00 */	oris r27, r0, 0x8000
lbl_800055F4:
/* 800055F4 000025F4  3C 80 80 00 */	lis r4, gTRKInterruptVectorTable@ha
/* 800055F8 000025F8  7F 63 DB 78 */	mr r3, r27
/* 800055FC 000025FC  38 04 35 E4 */	addi r0, r4, gTRKInterruptVectorTable@l
/* 80005600 00002600  38 A0 01 00 */	li r5, 0x100
/* 80005604 00002604  7C 80 32 14 */	add r4, r0, r6
/* 80005608 00002608  4B FF DF B9 */	bl TRK_memcpy
/* 8000560C 0000260C  7F 63 DB 78 */	mr r3, r27
/* 80005610 00002610  38 80 01 00 */	li r4, 0x100
/* 80005614 00002614  48 1E E4 DD */	bl TRK_flush_cache
lbl_80005618:
/* 80005618 00002618  3B 9C 00 01 */	addi r28, r28, 1
/* 8000561C 0000261C  3B FF 00 04 */	addi r31, r31, 4
/* 80005620 00002620  2C 1C 00 0E */	cmpwi r28, 0xe
/* 80005624 00002624  40 81 FF 60 */	ble lbl_80005584
/* 80005628 00002628  BB 61 00 0C */	lmw r27, 0xc(r1)
/* 8000562C 0000262C  80 01 00 24 */	lwz r0, 0x24(r1)
/* 80005630 00002630  7C 08 03 A6 */	mtlr r0
/* 80005634 00002634  38 21 00 20 */	addi r1, r1, 0x20
/* 80005638 00002638  4E 80 00 20 */	blr 


/* TODO: copy/paste from pik2 */

.global lbl_8000563C /* TODO: _rom_copy_info */
lbl_8000563C:
/* 8000563C 0000263C  80 00 31 00 */	lwz r0, 0x3100(0)
/* 80005640 00002640  80 00 31 00 */	lwz r0, 0x3100(0)
/* 80005644 00002644  00 00 25 E0 */	.4byte 0x000025E0  /* unknown instruction */
/* 80005648 00002648  80 00 56 E0 */	lwz r0, 0x56e0(0)
/* 8000564C 0000264C  80 00 56 E0 */	lwz r0, 0x56e0(0)
/* 80005650 00002650  00 00 01 04 */	.4byte 0x00000104  /* unknown instruction */
/* 80005654 00002654  80 00 58 00 */	lwz r0, 0x5800(0)
/* 80005658 00002658  80 00 58 00 */	lwz r0, 0x5800(0)
/* 8000565C 0000265C  00 00 00 D4 */	.4byte 0x000000D4  /* unknown instruction */
/* 80005660 00002660  80 00 58 E0 */	lwz r0, 0x58e0(0)
/* 80005664 00002664  80 00 58 E0 */	lwz r0, 0x58e0(0)
/* 80005668 00002668  00 24 C4 14 */	.4byte 0x0024C414  /* unknown instruction */
/* 8000566C 0000266C  80 25 1D 00 */	lwz r1, 0x1d00(r5)
/* 80005670 00002670  80 25 1D 00 */	lwz r1, 0x1d00(r5)
/* 80005674 00002674  00 00 00 28 */	.4byte 0x00000028  /* unknown instruction */
/* 80005678 00002678  80 25 1D 40 */	lwz r1, 0x1d40(r5)
/* 8000567C 0000267C  80 25 1D 40 */	lwz r1, 0x1d40(r5)
/* 80005680 00002680  00 00 00 10 */	.4byte 0x00000010  /* unknown instruction */
/* 80005684 00002684  80 25 1D 80 */	lwz r1, 0x1d80(r5)
/* 80005688 00002688  80 25 1D 80 */	lwz r1, 0x1d80(r5)
/* 8000568C 0000268C  00 02 88 30 */	.4byte 0x00028830  /* unknown instruction */
/* 80005690 00002690  80 27 A5 C0 */	lwz r1, -0x5a40(r7)
/* 80005694 00002694  80 27 A5 C0 */	lwz r1, -0x5a40(r7)
/* 80005698 00002698  00 03 E4 20 */	.4byte 0x0003E420  /* unknown instruction */
/* 8000569C 0000269C  80 3C A9 00 */	lwz r1, -0x5700(r28)
/* 800056A0 000026A0  80 3C A9 00 */	lwz r1, -0x5700(r28)
/* 800056A4 000026A4  00 00 08 50 */	.4byte 0x00000850  /* unknown instruction */
/* 800056A8 000026A8  80 3C C9 80 */	lwz r1, -0x3680(r28)
/* 800056AC 000026AC  80 3C C9 80 */	lwz r1, -0x3680(r28)
/* 800056B0 000026B0  00 00 3E 5C */	.4byte 0x00003E5C  /* unknown instruction */
/* 800056B4 000026B4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800056B8 000026B8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800056BC 000026BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global lbl_800056C0 /* TODO: _bss_init_info */
lbl_800056C0:
/* 800056C0 000026C0  80 2B 89 E0 */	lwz r1, -0x7620(r11)
/* 800056C4 000026C4  00 11 1F 08 */	.4byte 0x00111F08  /* unknown instruction */
/* 800056C8 000026C8  80 3C B1 60 */	lwz r1, -0x4ea0(r28)
/* 800056CC 000026CC  00 00 18 0C */	.4byte 0x0000180C  /* unknown instruction */
/* 800056D0 000026D0  80 3D 07 E0 */	lwz r1, 0x7e0(r29)
/* 800056D4 000026D4  00 00 02 70 */	.4byte 0x00000270  /* unknown instruction */
/* 800056D8 000026D8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800056DC 000026DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
