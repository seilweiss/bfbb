...
/* 800CA990 000C7790  C0 02 97 98 */	lfs f0, l_e118__esc__2_677@sda21(r2)
...
lbl_800CA9A4:
/* 800CA9A4 000C77A4  C0 02 97 9C */	lfs f0, l_e11c__esc__2_678@sda21(r2)
...
lbl_800CA9B4:
/* 800CA9B4 000C77B4  C0 42 97 A0 */	lfs f2, l_e120__esc__2_679@sda21(r2)
/* 800CA9B8 000C77B8  C0 02 97 A4 */	lfs f0, l_e124__esc__2_680@sda21(r2)
...
lbl_800CA9D0:
/* 800CA9D0 000C77D0  C0 02 97 A8 */	lfs f0, l_e128__esc__2_681@sda21(r2)
...
/* 800CAA20 000C7820  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAA24 000C7824  38 63 26 20 */	addi r3, r3, l_2620_sPadData@l
/* 800CAA28 000C7828  48 10 DE F9 */	bl PADRead
/* 800CAA2C 000C782C  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAA30 000C7830  38 63 26 20 */	addi r3, r3, l_2620_sPadData@l
/* 800CAA34 000C7834  48 10 D1 5D */	bl PADClamp
lbl_800CAA38:
/* 800CAA38 000C7838  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CAA3C 000C783C  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAA40 000C7840  38 A4 26 20 */	addi r5, r4, l_2620_sPadData@l
...
/* 800CAAB8 000C78B8  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAABC 000C78BC  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAADC 000C78DC  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAAE0 000C78E0  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAB00 000C7900  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAB04 000C7904  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAB24 000C7924  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAB28 000C7928  38 84 26 20 */	addi r4, r4, l_2620_sPadData@l
...
/* 800CAB50 000C7950  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAB54 000C7954  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAB74 000C7974  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAB78 000C7978  38 84 26 20 */	addi r4, r4, l_2620_sPadData@l
...
lbl_800CAB98:
/* 800CAB98 000C7998  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAB9C 000C799C  38 03 26 20 */	addi r0, r3, l_2620_sPadData@l
...
/* 800CABCC 000C79CC  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CABD0 000C79D0  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CABF0 000C79F0  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CABF4 000C79F4  38 84 26 20 */	addi r4, r4, l_2620_sPadData@l
...
lbl_800CAC14:
/* 800CAC14 000C7A14  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAC18 000C7A18  38 03 26 20 */	addi r0, r3, l_2620_sPadData@l
...
/* 800CAC34 000C7A34  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAC38 000C7A38  38 63 26 20 */	addi r3, r3, l_2620_sPadData@l
...
/* 800CAC54 000C7A54  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAC58 000C7A58  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAC78 000C7A78  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAC7C 000C7A7C  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CAC9C 000C7A9C  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CACA0 000C7AA0  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CACC0 000C7AC0  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CACC4 000C7AC4  38 C4 26 20 */	addi r6, r4, l_2620_sPadData@l
...
/* 800CACE4 000C7AE4  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CACE8 000C7AE8  93 FE 00 00 */	stw r31, 0(r30)
/* 800CACEC 000C7AEC  3C 00 43 30 */	lis r0, 0x4330
/* 800CACF0 000C7AF0  38 83 26 20 */	addi r4, r3, l_2620_sPadData@l
...
/* 800CAD00 000C7B00  C8 22 97 B0 */	lfd f1, l_e130__esc__2_719@sda21(r2)
...
/* 800CAD28 000C7B28  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CAD2C 000C7B2C  3C 00 43 30 */	lis r0, 0x4330
/* 800CAD30 000C7B30  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CAD34 000C7B34  38 84 26 20 */	addi r4, r4, l_2620_sPadData@l
/* 800CAD38 000C7B38  90 01 00 10 */	stw r0, 0x10(r1)
/* 800CAD3C 000C7B3C  1C 03 00 0C */	mulli r0, r3, 0xc
/* 800CAD40 000C7B40  C8 22 97 B0 */	lfd f1, l_e130__esc__2_719@sda21(r2)
...
/* 800CAD68 000C7B68  3C 60 80 29 */	lis r3, l_2620_sPadData@ha
/* 800CAD6C 000C7B6C  98 1D 00 39 */	stb r0, 0x39(r29)
/* 800CAD70 000C7B70  38 83 26 20 */	addi r4, r3, l_2620_sPadData@l
...
/* 800CAD84 000C7B84  C8 22 97 B0 */	lfd f1, l_e130__esc__2_719@sda21(r2)
...
/* 800CADAC 000C7BAC  3C 80 80 29 */	lis r4, l_2620_sPadData@ha
/* 800CADB0 000C7BB0  3C 00 43 30 */	lis r0, 0x4330
/* 800CADB4 000C7BB4  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CADB8 000C7BB8  38 84 26 20 */	addi r4, r4, l_2620_sPadData@l
/* 800CADBC 000C7BBC  90 01 00 20 */	stw r0, 0x20(r1)
/* 800CADC0 000C7BC0  1C 03 00 0C */	mulli r0, r3, 0xc
/* 800CADC4 000C7BC4  C8 22 97 B0 */	lfd f1, l_e130__esc__2_719@sda21(r2)
