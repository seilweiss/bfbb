...
/* 8010F848 0010C648  C0 22 9E 50 */	lfs f1, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010F858 0010C658  C0 02 9E 54 */	lfs f0, l_e7d4__esc__2_706@sda21(r2)
/* 8010F85C 0010C65C  D0 1E 00 2C */	stfs f0, 0x2c(r30)
lbl_8010F860:
/* 8010F860 0010C660  C0 22 9E 50 */	lfs f1, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010F870 0010C670  C0 02 9E 54 */	lfs f0, l_e7d4__esc__2_706@sda21(r2)
/* 8010F874 0010C674  D0 1E 00 30 */	stfs f0, 0x30(r30)
lbl_8010F878:
/* 8010F878 0010C678  C0 22 9E 50 */	lfs f1, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010F888 0010C688  C0 02 9E 54 */	lfs f0, l_e7d4__esc__2_706@sda21(r2)
...
/* 8010F954 0010C754  80 6D 89 E0 */	lwz r3, gActiveHeap@sda21(r13)
...
/* 8010F984 0010C784  80 6D 89 E0 */	lwz r3, gActiveHeap@sda21(r13)
...
/* 8010FA68 0010C868  C0 02 9E 50 */	lfs f0, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010FAB0 0010C8B0  C0 02 9E 60 */	lfs f0, l_e7e0__esc__2_721@sda21(r2)
/* 8010FAB4 0010C8B4  7F E3 FB 78 */	mr r3, r31
/* 8010FAB8 0010C8B8  C0 42 9E 5C */	lfs f2, l_e7dc__esc__2_720@sda21(r2)
/* 8010FABC 0010C8BC  EC 21 00 28 */	fsubs f1, f1, f0
/* 8010FAC0 0010C8C0  C0 02 9E 58 */	lfs f0, l_e7d8__esc__2_719@sda21(r2)
...
l_faf4_NPC_alwaysUseSphere__FP4xEntP5xVec3:
/* 8010FAF4 0010C8F4  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 8010FAF8 0010C8F8  7C 08 02 A6 */	mflr r0
/* 8010FAFC 0010C8FC  3C 80 80 27 */	lis r4, l_a3f8__esc__2_727@ha
/* 8010FB00 0010C900  90 01 00 24 */	stw r0, 0x24(r1)
/* 8010FB04 0010C904  38 C4 A3 F8 */	addi r6, r4, l_a3f8__esc__2_727@l
...
/* 8010FB40 0010C940  C0 02 9E 64 */	lfs f0, l_e7e4__esc__2_738@sda21(r2)
...
/* 8010FB5C 0010C95C  C0 02 9E 64 */	lfs f0, l_e7e4__esc__2_738@sda21(r2)
...
lbl_8010FBB4:
/* 8010FBB4 0010C9B4  80 02 81 A8 */	lwz r0, g_PIMP_GOLD@sda21(r2)
...
/* 8010FBF4 0010C9F4  C0 02 9E 68 */	lfs f0, l_e7e8__esc__2_770@sda21(r2)
...
/* 8010FC0C 0010CA0C  C0 02 9E 6C */	lfs f0, l_e7ec__esc__2_771@sda21(r2)
...
/* 8010FC5C 0010CA5C  C0 22 9E 70 */	lfs f1, l_e7f0__esc__2_772@sda21(r2)
...
/* 8010FD8C 0010CB8C  C0 02 9E 50 */	lfs f0, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010FDAC 0010CBAC  C0 02 9E 50 */	lfs f0, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010FDCC 0010CBCC  C0 02 9E 50 */	lfs f0, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010FDEC 0010CBEC  C0 02 9E 50 */	lfs f0, l_e7d0__esc__2_705@sda21(r2)
...
/* 8010FE4C 0010CC4C  4B FE 48 E9 */	bl DBG_PStatCont__9xNPCBasicF10en_npcperf
/* 8010FE50 0010CC50  7F E3 FB 78 */	mr r3, r31
/* 8010FE54 0010CC54  38 80 00 02 */	li r4, 2
/* 8010FE58 0010CC58  4B FE 48 D9 */	bl DBG_PStatOn__9xNPCBasicF10en_npcperf
...
/* 8010FE68 0010CC68  3C 60 80 29 */	lis r3, l_7460_g_colrec@ha
/* 8010FE6C 0010CC6C  38 80 00 00 */	li r4, 0
/* 8010FE70 0010CC70  38 63 74 60 */	addi r3, r3, l_7460_g_colrec@l
/* 8010FE74 0010CC74  38 A0 05 B4 */	li r5, 0x5b4
/* 8010FE78 0010CC78  4B EF 35 E1 */	bl memset
/* 8010FE7C 0010CC7C  3C 60 80 29 */	lis r3, l_7460_g_colrec@ha
/* 8010FE80 0010CC80  38 03 74 60 */	addi r0, r3, l_7460_g_colrec@l
/* 8010FE84 0010CC84  90 1F 00 4C */	stw r0, 0x4c(r31)
lbl_8010FE88:
/* 8010FE88 0010CC88  88 BF 00 F0 */	lbz r5, 0xf0(r31)
/* 8010FE8C 0010CC8C  3C 60 80 11 */	lis r3, l_faf4_NPC_alwaysUseSphere__FP4xEntP5xVec3@ha
/* 8010FE90 0010CC90  80 9F 00 4C */	lwz r4, 0x4c(r31)
/* 8010FE94 0010CC94  FC 20 F8 90 */	fmr f1, f31
/* 8010FE98 0010CC98  38 03 FA F4 */	addi r0, r3, l_faf4_NPC_alwaysUseSphere__FP4xEntP5xVec3@l
...
/* 8010FEF4 0010CCF4  4B FE 48 41 */	bl DBG_PStatCont__9xNPCBasicF10en_npcperf
/* 8010FEF8 0010CCF8  7F E3 FB 78 */	mr r3, r31
/* 8010FEFC 0010CCFC  38 80 00 01 */	li r4, 1
/* 8010FF00 0010CD00  4B FE 48 31 */	bl DBG_PStatOn__9xNPCBasicF10en_npcperf
lbl_8010FF04:
...
/* 8010FF18 0010CD18  4B F0 51 B5 */	bl xVec3Length2__FPC5xVec3
/* 8010FF1C 0010CD1C  C0 02 9E 74 */	lfs f0, l_e7f4__esc__2_856@sda21(r2)
...
/* 8010FF54 0010CD54  4B FC 92 AD */	bl DBG_IsNormLog__9xNPCBasicF10en_npcdcati
/* 8010FF58 0010CD58  2C 03 00 00 */	cmpwi r3, 0
/* 8010FF5C 0010CD5C  41 82 00 1C */	beq lbl_8010FF78
/* 8010FF60 0010CD60  80 02 81 88 */	lwz r0, g_BLUE@sda21(r2)
/* 8010FF64 0010CD64  38 61 00 08 */	addi r3, r1, 8
/* 8010FF68 0010CD68  90 01 00 08 */	stw r0, 8(r1)
/* 8010FF6C 0010CD6C  4B F0 F4 C9 */	bl xDrawSetColor__F10iColor_tag
...
/* 8010FFC4 0010CDC4  80 02 81 B0 */	lwz r0, g_LAVENDER@sda21(r2)
...
/* 801100AC 0010CEAC  C0 02 9E 7C */	lfs f0, l_e7fc__esc__2_914@sda21(r2)
...
/* 801100C4 0010CEC4  C3 E2 9E 78 */	lfs f31, l_e7f8__esc__2_913@sda21(r2)
lbl_801100C8:
