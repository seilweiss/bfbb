...
/* 8000E994 0000B794  C0 02 80 E8 */	lfs f0, lbl_803CCA68@sda21(r2)
/* 8000E998 0000B798  38 61 00 08 */	addi r3, r1, 8
/* 8000E99C 0000B79C  C0 42 80 F0 */	lfs f2, lbl_803CCA70@sda21(r2)
/* 8000E9A0 0000B7A0  EC 20 07 F2 */	fmuls f1, f0, f31
/* 8000E9A4 0000B7A4  C0 02 80 EC */	lfs f0, lbl_803CCA6C@sda21(r2)
...
/* 8000E9B4 0000B7B4  C0 22 80 F0 */	lfs f1, lbl_803CCA70@sda21(r2)
/* 8000E9B8 0000B7B8  7F E3 FB 78 */	mr r3, r31
/* 8000E9BC 0000B7BC  C0 62 80 F4 */	lfs f3, lbl_803CCA74@sda21(r2)
...
/* 8000EA0C 0000B80C  C0 02 80 F0 */	lfs f0, lbl_803CCA70@sda21(r2)
...
/* 8000EA90 0000B890  93 CD 88 88 */	stw r30, lbl_803CB188@sda21(r13)
/* 8000EA94 0000B894  C0 02 80 F0 */	lfs f0, lbl_803CCA70@sda21(r2)
...
/* 8000EAB0 0000B8B0  C0 02 80 F0 */	lfs f0, lbl_803CCA70@sda21(r2)
/* 8000EAB4 0000B8B4  D0 1E 00 10 */	stfs f0, 0x10(r30)
/* 8000EAB8 0000B8B8  C0 02 80 F0 */	lfs f0, lbl_803CCA70@sda21(r2)
...
/* 8000EADC 0000B8DC  C0 42 80 F8 */	lfs f2, lbl_803CCA78@sda21(r2)
...
/* 8000EB18 0000B918  C0 42 80 F8 */	lfs f2, lbl_803CCA78@sda21(r2)
...
/* 8000EB84 0000B984  C0 42 80 FC */	lfs f2, lbl_803CCA7C@sda21(r2)
...
/* 8000EB98 0000B998  C0 42 80 FC */	lfs f2, lbl_803CCA7C@sda21(r2)
...
/* 8000EBAC 0000B9AC  C0 42 80 FC */	lfs f2, lbl_803CCA7C@sda21(r2)
...
/* 8000EC40 0000BA40  C0 22 81 00 */	lfs f1, lbl_803CCA80@sda21(r2)
...
/* 8000EC70 0000BA70  C0 62 81 00 */	lfs f3, lbl_803CCA80@sda21(r2)
/* 8000EC74 0000BA74  C0 42 81 04 */	lfs f2, lbl_803CCA84@sda21(r2)
...
/* 8000EC8C 0000BA8C  C0 02 81 08 */	lfs f0, lbl_803CCA88@sda21(r2)
...
/* 8000EC9C 0000BA9C  C0 62 81 00 */	lfs f3, lbl_803CCA80@sda21(r2)
/* 8000ECA0 0000BAA0  38 81 00 14 */	addi r4, r1, 0x14
/* 8000ECA4 0000BAA4  C0 42 81 04 */	lfs f2, lbl_803CCA84@sda21(r2)
...
lbl_8000ECD4:
/* 8000ECD4 0000BAD4  C0 22 81 00 */	lfs f1, lbl_803CCA80@sda21(r2)
...
/* 8000ED44 0000BB44  C0 62 81 0C */	lfs f3, lbl_803CCA8C@sda21(r2)
/* 8000ED48 0000BB48  C0 42 81 10 */	lfs f2, lbl_803CCA90@sda21(r2)
...
/* 8000ED60 0000BB60  C0 42 81 0C */	lfs f2, lbl_803CCA8C@sda21(r2)
/* 8000ED64 0000BB64  C0 02 81 10 */	lfs f0, lbl_803CCA90@sda21(r2)
...
/* 8000ED8C 0000BB8C  C0 22 81 14 */	lfs f1, lbl_803CCA94@sda21(r2)
/* 8000ED90 0000BB90  EC 42 00 32 */	fmuls f2, f2, f0
/* 8000ED94 0000BB94  C0 02 80 F4 */	lfs f0, lbl_803CCA74@sda21(r2)
...
/* 8000EDD0 0000BBD0  C0 02 81 18 */	lfs f0, lbl_803CCA98@sda21(r2)
...
/* 8000EE10 0000BC10  C8 22 81 20 */	lfd f1, lbl_803CCAA0@sda21(r2)
/* 8000EE14 0000BC14  90 01 01 80 */	stw r0, 0x180(r1)
/* 8000EE18 0000BC18  C0 42 81 1C */	lfs f2, lbl_803CCA9C@sda21(r2)
...
/* 8000EE98 0000BC98  C0 62 81 0C */	lfs f3, lbl_803CCA8C@sda21(r2)
/* 8000EE9C 0000BC9C  C0 42 81 10 */	lfs f2, lbl_803CCA90@sda21(r2)
...
/* 8000EEB4 0000BCB4  C0 62 81 0C */	lfs f3, lbl_803CCA8C@sda21(r2)
/* 8000EEB8 0000BCB8  C0 42 81 10 */	lfs f2, lbl_803CCA90@sda21(r2)
...
/* 8000EEE0 0000BCE0  C0 62 81 14 */	lfs f3, lbl_803CCA94@sda21(r2)
/* 8000EEE4 0000BCE4  EC A2 00 28 */	fsubs f5, f2, f0
/* 8000EEE8 0000BCE8  C0 42 80 F4 */	lfs f2, lbl_803CCA74@sda21(r2)
/* 8000EEEC 0000BCEC  EC 81 00 72 */	fmuls f4, f1, f1
/* 8000EEF0 0000BCF0  C0 02 81 18 */	lfs f0, lbl_803CCA98@sda21(r2)
