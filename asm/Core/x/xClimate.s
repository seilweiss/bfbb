...
.global l_20f0_snow_vel
l_20f0_snow_vel:
	.4byte 0x00000000
	.4byte 0xC0000000
	.4byte 0x00000000
.global l_20fc_snow_dvel
l_20fc_snow_dvel:
	.4byte 0x3DCCCCCD
	.4byte 0x3DCCCCCD
	.4byte 0x3DCCCCCD
.global l_2108__esc__2_stringBase0
l_2108__esc__2_stringBase0:
	.4byte 0x50415245
	.4byte 0x4D49545F
	.4byte 0x5241494E
	.4byte 0x00504152
...
/* 8000E994 0000B794  C0 02 80 E8 */	lfs f0, l_ca68__esc__2_642@sda21(r2)
/* 8000E998 0000B798  38 61 00 08 */	addi r3, r1, 8
/* 8000E99C 0000B79C  C0 42 80 F0 */	lfs f2, l_ca70__esc__2_644@sda21(r2)
/* 8000E9A0 0000B7A0  EC 20 07 F2 */	fmuls f1, f0, f31
/* 8000E9A4 0000B7A4  C0 02 80 EC */	lfs f0, l_ca6c__esc__2_643@sda21(r2)
...
/* 8000E9B4 0000B7B4  C0 22 80 F0 */	lfs f1, l_ca70__esc__2_644@sda21(r2)
/* 8000E9B8 0000B7B8  7F E3 FB 78 */	mr r3, r31
/* 8000E9BC 0000B7BC  C0 62 80 F4 */	lfs f3, l_ca74__esc__2_645@sda21(r2)
...
/* 8000EA08 0000B808  3C 60 80 25 */	lis r3, l_2108__esc__2_stringBase0@ha
/* 8000EA0C 0000B80C  C0 02 80 F0 */	lfs f0, l_ca70__esc__2_644@sda21(r2)
/* 8000EA10 0000B810  38 63 21 08 */	addi r3, r3, l_2108__esc__2_stringBase0@l
...
/* 8000EA24 0000B824  3C 60 80 25 */	lis r3, l_2108__esc__2_stringBase0@ha
/* 8000EA28 0000B828  38 63 21 08 */	addi r3, r3, l_2108__esc__2_stringBase0@l
...
/* 8000EA90 0000B890  93 CD 88 88 */	stw r30, l_b188_sClimate@sda21(r13)
/* 8000EA94 0000B894  C0 02 80 F0 */	lfs f0, l_ca70__esc__2_644@sda21(r2)
...
/* 8000EAB0 0000B8B0  C0 02 80 F0 */	lfs f0, l_ca70__esc__2_644@sda21(r2)
/* 8000EAB4 0000B8B4  D0 1E 00 10 */	stfs f0, 0x10(r30)
/* 8000EAB8 0000B8B8  C0 02 80 F0 */	lfs f0, l_ca70__esc__2_644@sda21(r2)
...
/* 8000EADC 0000B8DC  C0 42 80 F8 */	lfs f2, l_ca78__esc__2_668@sda21(r2)
...
/* 8000EB18 0000B918  C0 42 80 F8 */	lfs f2, l_ca78__esc__2_668@sda21(r2)
...
xClimateSetSnow__Ff:
/* 8000EB50 0000B950  80 6D 88 88 */	lwz r3, l_b188_sClimate@sda21(r13)
/* 8000EB54 0000B954  38 00 00 00 */	li r0, 0
/* 8000EB58 0000B958  90 03 00 00 */	stw r0, 0(r3)
/* 8000EB5C 0000B95C  80 6D 88 88 */	lwz r3, l_b188_sClimate@sda21(r13)
/* 8000EB60 0000B960  D0 23 00 04 */	stfs f1, 4(r3)
/* 8000EB64 0000B964  4E 80 00 20 */	blr 

.global xClimateSetRain__Ff
xClimateSetRain__Ff:
/* 8000EB68 0000B968  80 6D 88 88 */	lwz r3, l_b188_sClimate@sda21(r13)
/* 8000EB6C 0000B96C  38 00 00 01 */	li r0, 1
/* 8000EB70 0000B970  90 03 00 00 */	stw r0, 0(r3)
/* 8000EB74 0000B974  80 6D 88 88 */	lwz r3, l_b188_sClimate@sda21(r13)
/* 8000EB78 0000B978  D0 23 00 04 */	stfs f1, 4(r3)
/* 8000EB7C 0000B97C  4E 80 00 20 */	blr 

GetPosBigDogWhattupFool__FP5xVec3:
/* 8000EB80 0000B980  80 8D 82 B0 */	lwz r4, xglobals@sda21(r13)
/* 8000EB84 0000B984  C0 42 80 FC */	lfs f2, l_ca7c__esc__2_685@sda21(r2)
...
/* 8000EB98 0000B998  C0 42 80 FC */	lfs f2, l_ca7c__esc__2_685@sda21(r2)
...
/* 8000EBAC 0000B9AC  C0 42 80 FC */	lfs f2, l_ca7c__esc__2_685@sda21(r2)
...
/* 8000EC40 0000BA40  C0 22 81 00 */	lfs f1, l_ca80__esc__2_740@sda21(r2)
...
/* 8000EC70 0000BA70  C0 62 81 00 */	lfs f3, l_ca80__esc__2_740@sda21(r2)
/* 8000EC74 0000BA74  C0 42 81 04 */	lfs f2, l_ca84__esc__2_741@sda21(r2)
...
/* 8000EC8C 0000BA8C  C0 02 81 08 */	lfs f0, l_ca88__esc__2_742@sda21(r2)
...
/* 8000EC9C 0000BA9C  C0 62 81 00 */	lfs f3, l_ca80__esc__2_740@sda21(r2)
/* 8000ECA0 0000BAA0  38 81 00 14 */	addi r4, r1, 0x14
/* 8000ECA4 0000BAA4  C0 42 81 04 */	lfs f2, l_ca84__esc__2_741@sda21(r2)
...
lbl_8000ECD4:
/* 8000ECD4 0000BAD4  C0 22 81 00 */	lfs f1, l_ca80__esc__2_740@sda21(r2)
...
/* 8000ECFC 0000BAFC  80 02 AB E8 */	lwz r0, gPTankDisable@sda21(r2)
/* 8000ED00 0000BB00  28 00 00 00 */	cmplwi r0, 0
/* 8000ED04 0000BB04  41 82 01 00 */	beq lbl_8000EE04
/* 8000ED08 0000BB08  3C 80 80 25 */	lis r4, l_20fc_snow_dvel@ha
/* 8000ED0C 0000BB0C  C7 24 20 FC */	lfsu f25, l_20fc_snow_dvel@l(r4)
/* 8000ED10 0000BB10  3C 60 80 25 */	lis r3, l_20f0_snow_vel@ha
/* 8000ED14 0000BB14  C7 C3 20 F0 */	lfsu f30, l_20f0_snow_vel@l(r3)
...
/* 8000ED44 0000BB44  C0 62 81 0C */	lfs f3, l_ca8c__esc__2_743@sda21(r2)
/* 8000ED48 0000BB48  C0 42 81 10 */	lfs f2, l_ca90__esc__2_744@sda21(r2)
...
/* 8000ED60 0000BB60  C0 42 81 0C */	lfs f2, l_ca8c__esc__2_743@sda21(r2)
/* 8000ED64 0000BB64  C0 02 81 10 */	lfs f0, l_ca90__esc__2_744@sda21(r2)
...
/* 8000ED8C 0000BB8C  C0 22 81 14 */	lfs f1, l_ca94__esc__2_745@sda21(r2)
/* 8000ED90 0000BB90  EC 42 00 32 */	fmuls f2, f2, f0
/* 8000ED94 0000BB94  C0 02 80 F4 */	lfs f0, l_ca74__esc__2_645@sda21(r2)
...
/* 8000EDD0 0000BBD0  C0 02 81 18 */	lfs f0, l_ca98__esc__2_746@sda21(r2)
...
/* 8000EDE0 0000BBE0  C0 0D 80 18 */	lfs f0, snow_life@sda21(r13)
...
/* 8000EE10 0000BC10  C8 22 81 20 */	lfd f1, l_caa0__esc__2_749@sda21(r2)
/* 8000EE14 0000BC14  90 01 01 80 */	stw r0, 0x180(r1)
/* 8000EE18 0000BC18  C0 42 81 1C */	lfs f2, l_ca9c__esc__2_747@sda21(r2)
...
/* 8000EE58 0000BC58  3C 80 80 25 */	lis r4, l_20fc_snow_dvel@ha
/* 8000EE5C 0000BC5C  C7 44 20 FC */	lfsu f26, l_20fc_snow_dvel@l(r4)
/* 8000EE60 0000BC60  3C 60 80 25 */	lis r3, l_20f0_snow_vel@ha
/* 8000EE64 0000BC64  C7 63 20 F0 */	lfsu f27, l_20f0_snow_vel@l(r3)
...
/* 8000EE98 0000BC98  C0 62 81 0C */	lfs f3, l_ca8c__esc__2_743@sda21(r2)
/* 8000EE9C 0000BC9C  C0 42 81 10 */	lfs f2, l_ca90__esc__2_744@sda21(r2)
...
/* 8000EEB4 0000BCB4  C0 62 81 0C */	lfs f3, l_ca8c__esc__2_743@sda21(r2)
/* 8000EEB8 0000BCB8  C0 42 81 10 */	lfs f2, l_ca90__esc__2_744@sda21(r2)
...
/* 8000EEE0 0000BCE0  C0 62 81 14 */	lfs f3, l_ca94__esc__2_745@sda21(r2)
/* 8000EEE4 0000BCE4  EC A2 00 28 */	fsubs f5, f2, f0
/* 8000EEE8 0000BCE8  C0 42 80 F4 */	lfs f2, l_ca74__esc__2_645@sda21(r2)
/* 8000EEEC 0000BCEC  EC 81 00 72 */	fmuls f4, f1, f1
/* 8000EEF0 0000BCF0  C0 02 81 18 */	lfs f0, l_ca98__esc__2_746@sda21(r2)
