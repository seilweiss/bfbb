...
/* 8001F8FC 0001C6FC  80 AD 88 EC */	lwz r5, lbl_803CB1EC@sda21(r13)
...
lbl_8001F918:
/* 8001F918 0001C718  80 6D 88 E8 */	lwz r3, lbl_803CB1E8@sda21(r13)
...
/* 8001F928 0001C728  80 6D 88 EC */	lwz r3, lbl_803CB1EC@sda21(r13)
/* 8001F92C 0001C72C  54 00 20 36 */	slwi r0, r0, 4
/* 8001F930 0001C730  7C 03 02 14 */	add r0, r3, r0
/* 8001F934 0001C734  90 0D 88 F0 */	stw r0, lbl_803CB1F0@sda21(r13)
...
xFFXAlloc__Fv:
/* 8001F948 0001C748  80 6D 88 F0 */	lwz r3, lbl_803CB1F0@sda21(r13)
...
/* 8001F960 0001C760  90 0D 88 F0 */	stw r0, lbl_803CB1F0@sda21(r13)
/* 8001F964 0001C764  4E 80 00 20 */	blr 

.global xFFXFree__FP4xFFX
xFFXFree__FP4xFFX:
/* 8001F968 0001C768  80 0D 88 F0 */	lwz r0, lbl_803CB1F0@sda21(r13)
/* 8001F96C 0001C76C  90 03 00 0C */	stw r0, 0xc(r3)
/* 8001F970 0001C770  90 6D 88 F0 */	stw r3, lbl_803CB1F0@sda21(r13)
...
/* 8001FBAC 0001C9AC  C0 42 82 C8 */	lfs f2, lbl_803CCC48@sda21(r2)
...
/* 8001FC9C 0001CA9C  80 AD 88 F8 */	lwz r5, lbl_803CB1F8@sda21(r13)
...
lbl_8001FCB0:
/* 8001FCB0 0001CAB0  80 6D 88 F4 */	lwz r3, lbl_803CB1F4@sda21(r13)
...
/* 8001FCC0 0001CAC0  80 6D 88 F8 */	lwz r3, lbl_803CB1F8@sda21(r13)
/* 8001FCC4 0001CAC4  1C 00 00 24 */	mulli r0, r0, 0x24
/* 8001FCC8 0001CAC8  7C 03 02 14 */	add r0, r3, r0
/* 8001FCCC 0001CACC  90 0D 88 FC */	stw r0, lbl_803CB1FC@sda21(r13)
...
xFFXShakeAlloc__Fv:
/* 8001FCE0 0001CAE0  80 6D 88 FC */	lwz r3, lbl_803CB1FC@sda21(r13)
...
/* 8001FCF8 0001CAF8  90 0D 88 FC */	stw r0, lbl_803CB1FC@sda21(r13)
/* 8001FCFC 0001CAFC  4E 80 00 20 */	blr 

.global xFFXShakeFree__FP14xFFXShakeState
xFFXShakeFree__FP14xFFXShakeState:
/* 8001FD00 0001CB00  80 0D 88 FC */	lwz r0, lbl_803CB1FC@sda21(r13)
/* 8001FD04 0001CB04  90 03 00 20 */	stw r0, 0x20(r3)
/* 8001FD08 0001CB08  90 6D 88 FC */	stw r3, lbl_803CB1FC@sda21(r13)
...
/* 8001FD58 0001CB58  80 AD 89 04 */	lwz r5, lbl_803CB204@sda21(r13)
...
lbl_8001FD6C:
/* 8001FD6C 0001CB6C  80 6D 89 00 */	lwz r3, lbl_803CB200@sda21(r13)
...
/* 8001FD7C 0001CB7C  80 6D 89 04 */	lwz r3, lbl_803CB204@sda21(r13)
/* 8001FD80 0001CB80  1C 00 00 44 */	mulli r0, r0, 0x44
/* 8001FD84 0001CB84  7C 03 02 14 */	add r0, r3, r0
/* 8001FD88 0001CB88  90 0D 89 08 */	stw r0, lbl_803CB208@sda21(r13)
...
/* 8001FD9C 0001CB9C  80 6D 89 08 */	lwz r3, lbl_803CB208@sda21(r13)
...
/* 8001FDB4 0001CBB4  90 0D 89 08 */	stw r0, lbl_803CB208@sda21(r13)
