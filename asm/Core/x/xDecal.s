...
/* 8017C420 00179220  80 0D 97 B0 */	lwz r0, lbl_803CC0B0@sda21(r13)
...
/* 8017C43C 0017923C  80 6D 97 B0 */	lwz r3, lbl_803CC0B0@sda21(r13)
/* 8017C440 00179240  38 03 00 01 */	addi r0, r3, 1
/* 8017C444 00179244  90 0D 97 B0 */	stw r0, lbl_803CC0B0@sda21(r13)
/* 8017C448 00179248  4E 80 00 20 */	blr 

.global xDecalInit__Fv
xDecalInit__Fv:
/* 8017C44C 0017924C  38 00 00 00 */	li r0, 0
/* 8017C450 00179250  90 0D 97 B0 */	stw r0, lbl_803CC0B0@sda21(r13)
...
/* 8017C460 00179260  3C 60 80 33 */	lis r3, lbl_8032B448@ha
...
/* 8017C474 00179274  3B E3 B4 48 */	addi r31, r3, lbl_8032B448@l
...
lbl_8017C4A8:
/* 8017C4A8 001792A8  80 0D 97 B0 */	lwz r0, lbl_803CC0B0@sda21(r13)
...
/* 8017C554 00179354  C0 02 AD F8 */	lfs f0, lbl_803CF778@sda21(r2)
...
/* 8017C564 00179364  C0 22 AD FC */	lfs f1, lbl_803CF77C@sda21(r2)
/* 8017C568 00179368  FC 40 08 90 */	fmr f2, f1
/* 8017C56C 0017936C  4B EA 9D AD */	bl assign__5xVec2Fff
/* 8017C570 00179370  C0 22 AD F8 */	lfs f1, lbl_803CF778@sda21(r2)
...
/* 8017C660 00179460  C0 02 AE 00 */	lfs f0, lbl_803CF780@sda21(r2)
...
lbl_8017C674:
/* 8017C674 00179474  C0 22 AD F8 */	lfs f1, lbl_803CF778@sda21(r2)
...
/* 8017C6B0 001794B0  C0 42 AD FC */	lfs f2, lbl_803CF77C@sda21(r2)
/* 8017C6B4 001794B4  C0 62 AE 04 */	lfs f3, lbl_803CF784@sda21(r2)
...
/* 8017C6C4 001794C4  C0 42 AD FC */	lfs f2, lbl_803CF77C@sda21(r2)
/* 8017C6C8 001794C8  C0 62 AE 04 */	lfs f3, lbl_803CF784@sda21(r2)
/* 8017C6CC 001794CC  4B E9 22 6D */	bl range_limit_esc__0_f_esc__1___Ffff
/* 8017C6D0 001794D0  D0 3F 00 14 */	stfs f1, 0x14(r31)
/* 8017C6D4 001794D4  C0 42 AE 08 */	lfs f2, lbl_803CF788@sda21(r2)
...
/* 8017C6E4 001794E4  C0 62 AD F8 */	lfs f3, lbl_803CF778@sda21(r2)
/* 8017C6E8 001794E8  4B E9 22 51 */	bl range_limit_esc__0_f_esc__1___Ffff
/* 8017C6EC 001794EC  D0 3F 00 18 */	stfs f1, 0x18(r31)
/* 8017C6F0 001794F0  C0 42 AE 08 */	lfs f2, lbl_803CF788@sda21(r2)
...
/* 8017C700 00179500  C0 62 AD F8 */	lfs f3, lbl_803CF778@sda21(r2)
...
/* 8017C73C 0017953C  C8 22 AE 10 */	lfd f1, lbl_803CF790@sda21(r2)
...
/* 8017C764 00179564  C8 22 AE 10 */	lfd f1, lbl_803CF790@sda21(r2)
...
/* 8017C77C 0017957C  C0 42 AD F8 */	lfs f2, lbl_803CF778@sda21(r2)
...
/* 8017C830 00179630  C0 02 AD FC */	lfs f0, lbl_803CF77C@sda21(r2)
...
/* 8017C848 00179648  C0 22 AD F8 */	lfs f1, lbl_803CF778@sda21(r2)
...
/* 8017C868 00179668  C0 02 AE 18 */	lfs f0, lbl_803CF798@sda21(r2)
...
/* 8017C8AC 001796AC  C0 02 AE 18 */	lfs f0, lbl_803CF798@sda21(r2)
...
/* 8017C99C 0017979C  C0 02 AD FC */	lfs f0, lbl_803CF77C@sda21(r2)
...
/* 8017C9DC 001797DC  C0 02 AE 18 */	lfs f0, lbl_803CF798@sda21(r2)
...
/* 8017CA48 00179848  C0 02 AE 18 */	lfs f0, lbl_803CF798@sda21(r2)
...
/* 8017CB4C 0017994C  C0 02 AD F8 */	lfs f0, lbl_803CF778@sda21(r2)
...
/* 8017CCC8 00179AC8  C0 42 AD F8 */	lfs f2, lbl_803CF778@sda21(r2)
...
/* 8017CE08 00179C08  C8 62 AE 10 */	lfd f3, lbl_803CF790@sda21(r2)
...
/* 8017CE34 00179C34  C8 42 AE 10 */	lfd f2, lbl_803CF790@sda21(r2)
...
/* 8017CF30 00179D30  C8 82 AE 10 */	lfd f4, lbl_803CF790@sda21(r2)
/* 8017CF34 00179D34  90 81 00 0C */	stw r4, 0xc(r1)
/* 8017CF38 00179D38  C0 A2 AE 18 */	lfs f5, lbl_803CF798@sda21(r2)
