...
/* 8004DC54 0004AA54  80 6D 8B 30 */	lwz r3, lbl_803CB430@sda21(r13)
/* 8004DC58 0004AA58  38 03 00 01 */	addi r0, r3, 1
/* 8004DC5C 0004AA5C  2C 03 00 00 */	cmpwi r3, 0
/* 8004DC60 0004AA60  90 0D 8B 30 */	stw r0, lbl_803CB430@sda21(r13)
...
/* 8004DC70 0004AA70  80 6D 8B 30 */	lwz r3, lbl_803CB430@sda21(r13)
...
xUtilShutdown__Fv:
/* 8004DC80 0004AA80  80 6D 8B 30 */	lwz r3, lbl_803CB430@sda21(r13)
/* 8004DC84 0004AA84  38 03 FF FF */	addi r0, r3, -1
/* 8004DC88 0004AA88  90 0D 8B 30 */	stw r0, lbl_803CB430@sda21(r13)
/* 8004DC8C 0004AA8C  80 6D 8B 30 */	lwz r3, lbl_803CB430@sda21(r13)
...
xUtil_crc_init__Fv:
/* 8004DEE8 0004ACE8  80 0D 80 B0 */	lwz r0, lbl_803CA9B0@sda21(r13)
...
/* 8004DFBC 0004ADBC  90 0D 80 B0 */	stw r0, lbl_803CA9B0@sda21(r13)
lbl_8004DFC0:
...
/* 8004DFEC 0004ADEC  80 0D 80 B0 */	lwz r0, lbl_803CA9B0@sda21(r13)
...
/* 8004E190 0004AF90  C0 02 87 D0 */	lfs f0, lbl_803CD150@sda21(r2)
...
lbl_8004E1A4:
/* 8004E1A4 0004AFA4  C0 02 87 D4 */	lfs f0, lbl_803CD154@sda21(r2)
...
/* 8004E1E8 0004AFE8  C0 62 87 D0 */	lfs f3, lbl_803CD150@sda21(r2)
...
/* 8004E1FC 0004AFFC  C0 02 87 D0 */	lfs f0, lbl_803CD150@sda21(r2)
