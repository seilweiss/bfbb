...
/* 8004DC54 0004AA54  80 6D 8B 30 */	lwz r3, l_b430_g_xutilinit@sda21(r13)
/* 8004DC58 0004AA58  38 03 00 01 */	addi r0, r3, 1
/* 8004DC5C 0004AA5C  2C 03 00 00 */	cmpwi r3, 0
/* 8004DC60 0004AA60  90 0D 8B 30 */	stw r0, l_b430_g_xutilinit@sda21(r13)
...
/* 8004DC70 0004AA70  80 6D 8B 30 */	lwz r3, l_b430_g_xutilinit@sda21(r13)
...
xUtilShutdown__Fv:
/* 8004DC80 0004AA80  80 6D 8B 30 */	lwz r3, l_b430_g_xutilinit@sda21(r13)
/* 8004DC84 0004AA84  38 03 FF FF */	addi r0, r3, -1
/* 8004DC88 0004AA88  90 0D 8B 30 */	stw r0, l_b430_g_xutilinit@sda21(r13)
/* 8004DC8C 0004AA8C  80 6D 8B 30 */	lwz r3, l_b430_g_xutilinit@sda21(r13)
...
lbl_8004DCBC:
/* 8004DCBC 0004AABC  3C 60 80 29 */	lis r3, l_a778_buf_esc__6_424@ha
/* 8004DCC0 0004AAC0  38 03 A7 78 */	addi r0, r3, l_a778_buf_esc__6_424@l
...
/* 8004DCD0 0004AAD0  3C 60 80 29 */	lis r3, l_a778_buf_esc__6_424@ha
/* 8004DCD4 0004AAD4  38 03 A7 78 */	addi r0, r3, l_a778_buf_esc__6_424@l
...
xUtil_crc_init__Fv:
/* 8004DEE8 0004ACE8  80 0D 80 B0 */	lwz r0, l_a9b0_g_crc_needinit@sda21(r13)
/* 8004DEEC 0004ACEC  2C 00 00 00 */	cmpwi r0, 0
/* 8004DEF0 0004ACF0  41 82 00 D0 */	beq lbl_8004DFC0
/* 8004DEF4 0004ACF4  3C 60 80 29 */	lis r3, l_a378_g_crc32_table@ha
/* 8004DEF8 0004ACF8  38 00 01 00 */	li r0, 0x100
/* 8004DEFC 0004ACFC  38 83 A3 78 */	addi r4, r3, l_a378_g_crc32_table@l
...
/* 8004DFBC 0004ADBC  90 0D 80 B0 */	stw r0, l_a9b0_g_crc_needinit@sda21(r13)
lbl_8004DFC0:
...
/* 8004DFEC 0004ADEC  80 0D 80 B0 */	lwz r0, l_a9b0_g_crc_needinit@sda21(r13)
...
/* 8004E018 0004AE18  3C 60 80 29 */	lis r3, l_a378_g_crc32_table@ha
/* 8004E01C 0004AE1C  54 00 E8 FE */	srwi r0, r0, 3
/* 8004E020 0004AE20  38 63 A3 78 */	addi r3, r3, l_a378_g_crc32_table@l
...
lbl_8004E11C:
/* 8004E11C 0004AF1C  3C 60 80 29 */	lis r3, l_a378_g_crc32_table@ha
/* 8004E120 0004AF20  7C 04 F8 50 */	subf r0, r4, r31
/* 8004E124 0004AF24  38 63 A3 78 */	addi r3, r3, l_a378_g_crc32_table@l
...
/* 8004E190 0004AF90  C0 02 87 D0 */	lfs f0, l_d150__esc__2_651@sda21(r2)
...
lbl_8004E1A4:
/* 8004E1A4 0004AFA4  C0 02 87 D4 */	lfs f0, l_d154__esc__2_652@sda21(r2)
...
/* 8004E1E8 0004AFE8  C0 62 87 D0 */	lfs f3, l_d150__esc__2_651@sda21(r2)
...
/* 8004E1FC 0004AFFC  C0 02 87 D0 */	lfs f0, l_d150__esc__2_651@sda21(r2)
